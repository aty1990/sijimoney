window.constans = {
    htmlUrl: "http://172.16.16.68/sijimoney",
    serviceUrl: "http://172.16.16.68/sijimoney",
    apiKey: "7d37e8d7cbaa4381b8767c07951d0840",
    // htmlUrl: "${project.domain}",
    // serviceUrl: "${project.domain}",
    accessToken: $.cookie("sijimoney_H5"),
